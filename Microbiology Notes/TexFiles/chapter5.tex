...
\textbf{Fission and Arthroconidia} – Fission occurs in genera like Schizosaccharomyces and arthroconidia form from the end of hyphae \cite{L2-YeastClass}.
...
\textbf{Importance of Sporulation} – Sporulation is crucial for yeast taxonomy and genetic resilience; sporogenous yeasts can better withstand environmental stresses and are often implicated in spoilage, e.g., S. cerevisiae var. diastaticus \cite*{L2-YeastClass}.
...
Beneath is a list with the typical ascospore form for the various genera of interest \cite*{L2-YeastClass}.
\vspace*{1em}

\begin{minipage}{0.5\textwidth}
    \begin{itemize}
        \item \textbf{Spherical, Ellipsoidal, or Reniform}
        \subitem \textit{Debaryomyces}
        \subitem \textit{Galactomyces (Geotrichum)}
        \subitem \textit{Kazachstania}
        \subitem \textit{Kluyveromyces}
        \subitem \textit{Saccharomyces}
        \subitem \textit{Saccharomycodes}
        \subitem \textit{Schizosaccharomyces}
        \subitem \textit{Torulaspora}
        \subitem \textit{Zygosaccharomyces}
    \end{itemize}
\end{minipage}
\begin{minipage}{0.5\textwidth}
    \begin{itemize}
        \item \textbf{Hat- or Saturnshaped} (Spherical, Ellipsoidal or Reniform may occur)
        \subitem \textit{Dekkera (Brettanomyces)}
        \subitem \textit{Hanseniaspora (Kloeckera)}
        \subitem \textit{Pichia}
        \subitem \textit{Saccharomycopsis}
        \subitem \textit{Yarrowia}
        \subitem
        \subitem
        \subitem
    \end{itemize}
