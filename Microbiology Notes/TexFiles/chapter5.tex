...
\subsection{Classification of Prokaryotes}

\subsubsection*{Classification Based on 16S rRNA Gene Sequence Comparison}
...
\subsubsection*{Classification Based on Multilocus Sequence Analysis (MLSA)}
...
\subsection{Classification of the Taxonomic Hierarchy}
\subsubsection*{Classification of Species}
...
\subsubsection*{Classification of Genera}
...
\subsubsection*{Classification of Families, Orders, Classes, and Phyla}
...
\begin{table}[h]
    ...
    \end{tikzpicture}
    \end{table}
\subsection{Rules for the Naming of a New Prokaryote}
...
\subsubsection*{Bacterial Species Names Are Linked to the Type Strain}
...
\subsection{The Benefits of Sequence-Based Identification}
...
\subsubsection*{16S rRNA Sequence-Based Identification}
...
\subsubsection*{16S rRNA-Based Identification Without Culture}
...
\subsection{Activity: Identifying Bacterial Isolates}
