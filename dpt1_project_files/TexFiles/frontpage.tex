\begin{titlepage}
    ...
    \begin{textblock}{9.4}(0,8)
        \Huge{\fontfamily{ptm}\selectfont\bfseries{Dairy Product Technology 1}}
    \end{textblock}
    \begin{textblock}{9.4}(0,9)
        \Huge{\fontfamily{ptm}\selectfont\bfseries{NFOK21005U}}
    \end{textblock}
    ...
    \begin{textblock}{8.4}(0,16.5)
        \large{\fontfamily{ptm}\selectfont{Link to Git repo.: \url{https://github.com/DanishUnicorn/dpt1_notes}}}
    \end{textblock}
